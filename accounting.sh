...
rrdtool graph $WEB_ROOT/img/qw_2week.png  -a PNG -s -2week  -t "Pending Jobs (Weekly)"  -h 200 -w 600 -v "Used CPU's" COMMENT:'                    ' COMMENT:"Min"  COMMENT:" Max"  COMMENT:"  Avg" COMMENT:" Last\\l"   $pending_datagrups   COMMENT:"Last update\: $DATE" 
